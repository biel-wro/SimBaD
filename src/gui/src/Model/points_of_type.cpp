...
simbad::gui::points_of_type::points_of_type(const points_of_type &that)
{
  ...
  Number_of_points_in_SpacePointArray =
      that.Number_of_points_in_SpacePointArray;
  for(int i = 0; i < Number_of_points_in_SpacePointArray; i++)
  {
    ...
    SpacePointArray[i].number_of_point_in_cell =
        that.SpacePointArray[i].number_of_point_in_cell;
...
void simbad::gui::points_of_type::Changing_of_color_and_points(
    int Number_of_points, QColor InitConfColor, QColor DynSimColor,
    const QVector<Point_of_space> &Array_of_points)

{
  ...
  {
    SpacePointArray[Number_of_points_in_SpacePointArray + i].BirthTime =
        Array_of_points.at(i).BirthTime;
    SpacePointArray[Number_of_points_in_SpacePointArray + i]
        .number_of_point_in_cell =
        Array_of_points.at(i).number_of_point_in_cell;
    SpacePointArray[Number_of_points_in_SpacePointArray + i].Xcoordinate =
        Array_of_points.at(i).Xcoordinate;
    SpacePointArray[Number_of_points_in_SpacePointArray + i].Ycoordinate =
        Array_of_points.at(i).Ycoordinate;
  }

  Number_of_points_in_SpacePointArray =
      Number_of_points_in_SpacePointArray + Number_of_points;
}
...
void simbad::gui::points_of_type::setNumber_of_points_in_SpacePointArray(
    int Number)
{
