...
simbad::gui::Event_of_model::Event_of_model(
    int Number_of_types_in_model_for_event)
{
  ...
  Table_of_component_rates_for_event_of_model.Number_of_types =
      Number_of_types_in_model_for_event;
...
simbad::gui::Event_of_model &simbad::gui::Event_of_model::
operator=(const Event_of_model &that)
{
  Name_of_event = that.Name_of_event;
  // Code_of_event = that.Code_of_event;
  Type_of_event = that.Type_of_event;
...
// void simbad::gui::Event_of_model::set_code_of_event(QVector
// <type_of_particle_before_and_after_event> & Code_of_event_in_model)
//{
...
void simbad::gui::Event_of_model::set_name_of_event(
    QString Name_of_event_in_model)
{
  Name_of_event = Name_of_event_in_model;
}

void simbad::gui::Event_of_model::set_type_of_event(
    QString Type_of_event_in_model)
{
  Type_of_event = Type_of_event_in_model;
}

void simbad::gui::Event_of_model::set_number_of_types_for_event_of_model(
    int Number)
{
...
void simbad::gui::Event_of_model::set_code_of_event(
    QString Code_of_event_string)
{
  if(Code_of_event_string.contains("birth of one particle with type # "))
  {
    ...
    // std::cout << "void
    // simbad::gui::Dialog_open_model::on_pushButton_4_clicked()++++" <<
    // std::endl;
  };
