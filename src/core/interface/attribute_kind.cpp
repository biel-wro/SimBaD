...
#define SIMBAD_ATTRIBUTE_KIND_MAPPING_PAIR(name) {ATTRIBUTE_KIND::name, #name }
  ...
  std::vector<kind2str::value_type> pairs{
      SIMBAD_ATTRIBUTE_KIND_MAPPING_PAIR(PARTICLE_UID),
      SIMBAD_ATTRIBUTE_KIND_MAPPING_PAIR(PARENT_UID),
      SIMBAD_ATTRIBUTE_KIND_MAPPING_PAIR(PARTICLE_POSITION),
      SIMBAD_ATTRIBUTE_KIND_MAPPING_PAIR(EVENT_UID),
      SIMBAD_ATTRIBUTE_KIND_MAPPING_PAIR(EVENT_TIME),
      SIMBAD_ATTRIBUTE_KIND_MAPPING_PAIR(EVENT_DELTA_TIME),
