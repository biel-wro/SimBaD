...
simbad::gui::result_of_event::result_of_event(int time,
...
QVector<simbad::gui::result_point_of_space> simbad::gui::result_of_event::get_vector_of_dead_points()
{
    return Vector_of_dead_points;
}

QVector<simbad::gui::result_point_of_space> simbad::gui::result_of_event::get_vector_of_new_points()
{
    return Vector_of_new_points;
}

void simbad::gui::result_of_event::set_vector_of_new_points(QVector<result_point_of_space> New_points)
{
   Vector_of_new_points=New_points;
}
void simbad::gui::result_of_event::set_vector_of_dead_points(QVector<result_point_of_space> Dead_points)
{
...
void simbad::gui::result_of_event::set_global_time_of_result_event(long double time)
{
