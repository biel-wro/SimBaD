...
simbad::gui::function_for_component_rate::function_for_component_rate(
    const function_for_component_rate &that)
...
void simbad::gui::function_for_component_rate::set_Restriction(
    Restrictions Restriction)
{
  Restriction_of_the_range = Restriction;
}

void simbad::gui::function_for_component_rate::set_Approach_of_influence(
    Approach_of_influence Approach_of_inf)
{
  Approach = Approach_of_inf;
}

void simbad::gui::function_for_component_rate::set_Restrictions_from_string(
    QString A)
{
  if(A == "--")
  {
  ...
  if((A != "--") and (A != "circle") and (A != "square"))
  {
    Restriction_of_the_range = zero;
  };
}

void simbad::gui::function_for_component_rate::
    set_Approach_of_influence_from_string(QString A)
{
  if(A == "no")
  {
    Approach = no;
...
void simbad::gui::function_for_component_rate::set_Constant_rate_plus(
    float value)
{
  Constant_rate_plus = value;
}

void simbad::gui::function_for_component_rate::set_Multiplication_by_constant(
    float value)
{
  Multiplication_by_constant = value;
}

void simbad::gui::function_for_component_rate::set_Range_of_the_function(
    float value)
{
...
QString
simbad::gui::function_for_component_rate::get_string_of_Approach_of_influence()
{
  if(Approach == no)
  {
    return "no";
...
simbad::gui::Restrictions
simbad::gui::function_for_component_rate::get_Restrictions()
{
  return Restriction_of_the_range;
}

simbad::gui::Approach_of_influence
simbad::gui::function_for_component_rate::get_Approach_of_influence()
{
  return Approach;
}
...
float simbad::gui::function_for_component_rate::get_max_of_Function()
{
  ...
  if(Function == modul)
  {
    if(Restriction_of_the_range == zero)
      return (0 + Constant_rate_plus);
    if(Restriction_of_the_range == circle)
      return (Multiplication_by_constant * Range_of_the_function +
              Constant_rate_plus);
    if(Restriction_of_the_range == square)
      return (Multiplication_by_constant * Range_of_the_function * sqrt(2) +
              Constant_rate_plus);
  };
  ...
  if(Function == zero_next_to_null)
  {
    ...
    if(Range_of_the_function > 1)
    {
      ...
      if(Restriction_of_the_range == circle)
        return ((Range_of_the_function - 1) * Multiplication_by_constant +
                Constant_rate_plus);
  ...
  if(Function == min)
  {
    ...
    if(Restriction_of_the_range == circle)
      return (Range_of_the_function * Multiplication_by_constant +
              Constant_rate_plus);

    if(Restriction_of_the_range == square)
      return (Range_of_the_function * Multiplication_by_constant * sqrt(2) +
              Constant_rate_plus);
  };
...
float simbad::gui::function_for_component_rate::get_value_of_Function(
    float dist)
{
  // Functions Function=Function_for_rate;
  ...
  if(Function_for_rate == triangle)
  {
    if(dist >= Range_of_the_function)
    {
      ...
      return Multiplication_by_constant * (-dist + 1) + Constant_rate_plus;
  };
...
void simbad::gui::function_for_component_rate::set_influent_particle_type(
    int Type)
{
  influent_particle_type = Type;
}

int simbad::gui::function_for_component_rate::get_influent_particle_type()
{
  return influent_particle_type;
}
