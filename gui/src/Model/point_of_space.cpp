...
void simbad::gui::Point_of_space::setCellNumber_of_point (unsigned int Cell_number_of_point)
{
...
float simbad::gui::Point_of_space::getXcoordinate ()
{
    return Xcoordinate;
}
float simbad::gui::Point_of_space::getYcoordinate ()
{
    return Ycoordinate;
}
...
double simbad::gui::Point_of_space::getBirthTime ()
{
    return BirthTime;
}
