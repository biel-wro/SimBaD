...
class parameter_evolution_3d : public simbad::core::model, public simbad::core::configuration_view
{
public:
  parameter_evolution_3d(simbad::core::property_tree const &pt);

  void generate_events(event_visitor, std::size_t nevents) override;
  simbad::core::configuration_view const &current_configuration() const override;
