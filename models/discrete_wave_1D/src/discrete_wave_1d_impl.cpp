...
discrete_wave_1d_impl::discrete_wave_1d_impl(double alpha, double intensity_cap,
...
discrete_wave_1d_impl::~discrete_wave_1d_impl() {}

discrete_wave_1d_impl::Event discrete_wave_1d_impl::initial_event()
{
  grid_count[0] += 1;
...
discrete_wave_1d_impl::Event discrete_wave_1d_impl::next_event()
{
...
double discrete_wave_1d_impl::get_spacing() const { return grid_spacing; }

const std::vector<std::size_t> &discrete_wave_1d_impl::get_counts() const
{
  return grid_count;
}

void discrete_wave_1d_impl::update_birth_uncapped_density(Event const &e)
{
...
void discrete_wave_1d_impl::recompute_birth_cumulated_density()
{
...
std::size_t
discrete_wave_1d_impl::sample_birth_pos(std::mt19937_64 &engine) const
{
...
double discrete_wave_1d_impl::capped_intensity(double uncapped_density) const
{
  return std::min(uncapped_density, intensity_cap);
}

double discrete_wave_1d_impl::distance_from_origin(size_t cell) const
{
  return cell * grid_spacing;
}

double discrete_wave_1d_impl::total_birth_intensity() const
{
